...
int main(int argc, char **argv)
{
    ...
    int opc;
    //Abrir el fichero
    fp=fopen("C:\\Users\\stic\\Documents\\pr10\\pr10_ej1\\Debug\\biblioteca.dat","r+b");
    if (fp==NULL) {
...
void MostrarLibros(FILE *pf) {
    ...
    do {
        ...
        if (ctrl==1) {
            if(libro.fecha_publicacion.dia!=0 && libro.fecha_publicacion.mes!=0 && libro.fecha_publicacion!=0) {
                MostrarUnLibro(&libro);
            }           
        }        
    }while(ctrl==1);
